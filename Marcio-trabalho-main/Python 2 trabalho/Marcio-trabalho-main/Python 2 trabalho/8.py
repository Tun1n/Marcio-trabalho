...
data['age_group'] = pd.cut(data['age'], bins = [0, 40, 70, 150], labels = ['young', 'Middle-Aged', 'Senior'])
...
young_by_industry = young_billionaires['industries'].value_counts().head(5) # Top 5 setores
print("\n Top 5 s egores com maior número de bilionários jovens:")
print(young_by_industry)

# Identifique os setores com maior número de bilionários idosos
senior_billionaires = data[data['age_group'] == 'Senior']
senior_by_industry = senior_billionaires['industries'].value_counts().head(5) # Top 5 setores
